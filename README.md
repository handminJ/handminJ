...
```yaml
role: Full-Stack Developer & AI Prompt Creator
location: South Korea 🇰🇷
motto: "동작하는 코드에서 멈추지 않고, 왜 그렇게 동작하는지까지"

currently:
  working_on: "바이브 코딩을 활용한 AI 및 웹 서비스 빌드"
  learning:   ["Vibe Coding Workflow", "Advanced Prompting", "Vercel Deployment"]
  interested: ["AI-Assisted Development", "Rapid Prototyping", "Micro Web Apps"]
  ask_me_about: ["Side Projects", "AI Prompts", "Web Hosting"]
```
...
<table>
  ...
  <tr>
    <td align="center"><b>🧩&nbsp;Framework<br/>&&nbsp;Library</b></td>
    <td>
  ...
  <tr>
    <td align="center"><b>⚙️&nbsp;DevOps<br/>&&nbsp;Tools</b></td>
    <td>
...
<div align="center">
  ...
  <sub>⭐️ From <a href="https://github.com/handminJ">@handminJ</a></sub>
